...
<body>
    <div class="container">
        <header class="page-header">
            <div>
                <h1 class="page-title">BCA Courses</h1>
                <div class="muted">Manage BCA courses and subjects</div>
            </div>
            <div>
                ...
                foreach ($courseTerms as $tableName => $label): ?>
                    <section class="section-card card" data-term="<?php echo htmlspecialchars($tableName); ?>">
                        <div class="section-header" style="display:flex;justify-content:space-between;align-items:center;">
                            ...
                            <div>
                                <a class="btn btn-outline" href="add_course.php?table=<?php echo urlencode($tableName); ?>">+ Add Course</a>
                            </div>
                        </div>
                        <?php 
