<?php
// Page: internal_mca.php
// Purpose: Allow moderators to add internal marks for courses they instruct (MCA).
...
// Render page: list all MCA terms and courses; for moderator only their courses
$courseTerms = [
...
<head>
    ...
    <title>Internal Marks — MCA</title>
...
<body>
    <div class="container">
        <header class="page-header">
            <div>
                <h1 class="page-title">Internal Marks — MCA</h1>
